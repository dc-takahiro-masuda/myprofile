            ...
            <ContentBody>
                ...
                <FadeInRight>
                    <TopicCard
                        ...
                        content={
                            <>
                                1998年生まれ。埼玉県所沢市在住。幼少の頃より家族からたくさんの愛情を受けて不自由なく育つ。
                                高校生の頃に囲碁AIのAlphaZeroを見て衝撃を受け、情報系の進路を志す。
                                電気通信大学に入学し学部を6年かけて卒業したため実質的に院卒となった。
                                学部時代は古賀研究室に所属し株価予測に関する研究を行っていた。
                                2024年にドリームキャリアに入社。
                            </>} />
                </FadeInRight>
                <FadeInRight>
                    <TopicCard
                        ...
                        content={
                            <>
                                <div>やる気にムラがあり、大きなエネルギーを出して頑張る時もあれば突然何もやる気が無くなってしまうことがあります。</div>
                                <a
                                    className="text-blue-400 underline underline-offset-4"
                                    href="https://www.16personalities.com/ja/結果/infp-t/x/2ujp9zg7c">
                                    16タイプ性格診断
                                </a>
                                を受けてみたので参考までにどうぞ。
                            </>
